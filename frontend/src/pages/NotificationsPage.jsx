...
const CATEGORY_MAP = {
  all: [],
  donations: ['DONATION_CREATED', 'DONATION_APPROVED', 'DONATION_REJECTED', 'DONATION_COMPLETED', 'NEW_DONATION_SUBMITTED'],
  requests: ['FOOD_REQUEST_CREATED', 'FOOD_REQUEST_ACCEPTED', 'FOOD_REQUEST_APPROVED', 'FOOD_REQUEST_REJECTED', 'FOOD_REQUEST_FULFILLED', 'NEW_FOOD_REQUEST'],
  verification: ['USER_REGISTERED', 'NGO_REGISTERED', 'USER_VERIFIED', 'USER_REJECTED', 'NGO_VERIFIED', 'NGO_REJECTED', 'PENDING_VERIFICATION'],
